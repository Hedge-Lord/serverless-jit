...
public class Handler implements com.openfaas.model.IHandler {
	...
	private static final int wordMin = 2500; /* Preset for the minimum of words read */
	private static final int wordMax = 50000; /* Preset for the maximum of words read */
	private static final double scalingFactor = (wordMax / 20); /*
																 * Preset for scaling the mutability for length of data
																 * to be hashed
																 */
	...
	public Handler() {
		...
		try {
			data = Files.readLines(input, Charset.forName("UTF-8"));
		} catch (Exception e) {
			// pass
		}
	}
	...
	private long benchmark() throws java.io.IOException {
